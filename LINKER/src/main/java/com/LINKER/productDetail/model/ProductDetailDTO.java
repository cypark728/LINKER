...
public class ProductDetailDTO {
	...
	public ProductDetailDTO(int productDetailId, String productDescription, String productContactInfo,
			Timestamp productCreatedAt, int productPrice, String productType, int userID) {
		super();
